...
void s21_parse_div(s21_decimal_long tmp_val_1, s21_decimal_long tmp_val_2,
  ...
  if (scale_1 < 39 && scale_2 < 39) {
    s21_normalize_div_modules(&tmp_val_1, &tmp_val_2, result, scale_1, scale_2);
    if (sign_1 != sign_2) {
      s21_set_bit_true(result, 127);
    }
